...
| | |
|---|---|
| [docs/LIVE-USB.md](docs/LIVE-USB.md) | Running from a USB stick: building it, writing it (including from Windows), persistence, and why it cannot touch your disks |
